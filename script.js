...
function checkNumber() {
  ...
  result.innerHTML = number ? number : 'NUMERO VACIO';
...
function anim() {
	addClassDelayed($("#countdown"), "", 0);
	if (currentNum == 0) currentNum = currentNum; else currentNum--;
...
$(function () {
	...
	self.setInterval(function () { anim() }, 1000);
});
var goodEvening = document.getElementById("remplazarcds");
setTimeout(function () { hide(goodEvening); }, 5001);
function hide(element) {
	element.style.display = "none";
}
var countdow = document.getElementById("countdown");
setTimeout(function () { hide(countdow); }, 5001);
function hide(element) {
	element.style.display = "none";
}
...
function doRefresh() {
	$("#box").load("#box");
	document.getElementById("box").innerHTML = Math.random();
}
$(function () {
	setInterval(contasea, 5000);
});
$(function () {
	setInterval(genQrCode, 100);
});
$(function () {
	setInterval(agecalculator, 100);
});



var charArr = '1234567890'.split('');
var password;
function contasea() {
	password = '';
	for (var i = 0; i < 6; i++) {
...
function agecalculator() {
	...
	if (userinput == null || userinput == '') {
		document.getElementById("message").innerHTML = "**PON UNA FECHA";
		return false;
	} else {
...
function genQrCode() {
	var imagen = document.getElementById("url").innerHTML;
	var nombre = document.getElementById('nombre').value;
	var apellido = document.getElementById('apellido').value;
	var email = document.getElementById('email').value;
	var tel = document.querySelector(".result").innerHTML + " " + addressDropdown.value.toUpperCase();
	var edad = document.getElementById('result').innerHTML;
	var clasesparaadultos = document.getElementById('clasesparaadultos').value + document.getElementById('precioadultos').innerHTML;
	var codigoseguridad = document.getElementById('box').className + document.getElementById('box').innerHTML;
	var clasesparaninos = document.getElementById('clasesparaninos').value + document.getElementById('preciopeques').innerHTML;
	...
	console.log(imagen, nombre, apellido, email, tel, edad, clasesparaadultos, clasesparaninos, clasesdefreestylesalom, clasesenescuelas, codigoseguridad);
	var str = "FOTOPERFIL:" + imagen + "\nNOMBRE: " + nombre + "\nAPELLIDO: " + apellido + "\nEMAIL:" + email + "\nTELEFONO:" + tel + "\nEDAD: " + edad + "\n" + clasesparaadultos + "" + clasesparaninos + "" + clasesdefreestylesalom + "" + clasesenescuelas + codigoseguridad;
	$("#reemplazarn").text(nombre);
	$("#reemplazara").text(apellido);
	$("#reemplazaremail").text(email);
	$("#reemplazarnumero").text(tel);
	$("#reemplazarcpa").text(clasesparaadultos);
	$("#box1").html("");
	const qrcode = new QRCode("box1", {
		text: str,
		width: 250,
		height: 250,
		scale: 5,
		...
		logo:"https://www.gesfast.id/material-logo/FA_logo_gesfast-01-putih.jpg", // LOGO
	...
	html2canvas($("#A4Page"), {
		...
		onrendered: function (canvas) {
			...
			canvas.toBlob(function (blob) {
				saveAs(blob, "CLASE_DE_PATINAJE.png");
			});
		}
	});
}
...
(function () {
	...
	var svgDrawer = (function () {
		...
		Drawing.prototype.draw = function (oQRCode) {
			...
			var svg = makeSVG("svg", { 'viewBox': '0 0 ' + String(nCount) + " " + String(nCount), 'width': '50%', 'height': '50%', 'fill': _htOption.colorLight });
